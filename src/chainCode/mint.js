...
export async function mint(
    ...
    const configAddress = new PublicKey(machineState.configState.program.config);
    const mint = Keypair.generate();

    const userKeyPair = loadWalletKey(keypairPath);
    ...
    console.log(`candyMachine: ${candyMachine.toString()}`);
